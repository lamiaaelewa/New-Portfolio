...
import cvFile from "../../assets/CV/Lamiaa_Elewa_CV.pdf";
  ...
  return (
    <section className="flex flex-col md:flex-row items-center min-h-screen bg-black text-white px-10 overflow-hidden">
      ...
      <div className="md:w-1/2 w-full flex flex-col justify-center">
        <p className="text-lg text-gray-400" data-aos="fade-down">
          Hello, my name is
        </p>
        <h2 className="text-6xl font-bold text-white" data-aos="fade-right">
          Lamiaa Elewa
        </h2>
        <p
          className="text-3xl mt-2 font-semibold text-[#0097b2]"
          data-aos="fade-left"
        >
        ...
        <p
          ...
          data-aos="zoom-in"
        >
          Passionate about creating intuitive and user-friendly interfaces. I
          have a strong interest in UI/UX design, networking, and cybersecurity.
        </p>
        {/* Social Icons */}
        <div className="flex gap-5 mt-6" data-aos="fade-up">
          <a
            ...
            target="_blank"
            className="text-[#0097b2] text-2xl hover:text-white transition"
          >
            <FaGithub />
          </a>
        ...
        <a
          ...
          hover:bg-[#0097b2] hover:text-white transition transform hover:scale-105 text-center"
          data-aos="flip-left"
        >
          View CV
        </a>
